---
title: "Week 10: Roots and Optima Intro"
author: "Clay Wright"
format: 
  html:
    toc: true
...
f <- function(mp = 1,cd = 1,g = 9.8,v = 36,t = 4){ # all variables in the equation are arguments
  sqrt(g*mp/cd)*tanh(sqrt(g*cd/mp)*t)-v # what the function does
  # by default our output is the result of the above line
}

f(mp = 147, cd = cd, g = g, v = v, t = t) 

plot(mp,f(mp,cd,g,v,t)) # plot our function f 
...
```{r}
(mass <- uniroot(f = f, interval = c(50,200), cd = cd, g = g, v = v, t = t))
# cd, g, v, t are `... =` additional named or unnamed arguments to be passed 
# to f. I've named cd and g, v and t are not named, so they need to be in the 
...
You buy a \$25,000 piece of equipment for nothing down at \$5,500 per year for 6 years. What intereest rate are you paying? The formula relating present worth $P$, annual payments $A$, number of years $n$, and interest rate $i$ is
